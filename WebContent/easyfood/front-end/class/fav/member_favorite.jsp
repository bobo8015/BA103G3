...
<!-- 		<link rel="short Icon" type="images/x-icon" href="images/logo.jpg"> -->
	   	<link rel="stylesheet" href="<%=request.getContextPath()%>/easyfood/front-end/class/fav/css/member.css">
	    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/easyfood/front-end/class/fav/css/favorite.css">
		<!--[if lt IE 9]>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="<%=request.getContextPath()%>/easyfood/front-end/class/fav/images/P01.jpg" alt="one"  width="570" height="200">
                </div>
  
                <div class="item">
                  <img src="<%=request.getContextPath()%>/easyfood/front-end/class/fav/images/P02.jpg" alt="two" width="570" height="200">
                </div>
  
                <div class="item">
                  <img src="<%=request.getContextPath()%>/easyfood/front-end/class/fav/images/P03.jpg" alt="three"  width="570" height="200">
                </div>
              </div>
